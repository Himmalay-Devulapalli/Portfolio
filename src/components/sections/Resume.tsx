...
export default function Resume() {
  return (
    <section id="resume" className="border-t border-border px-6 pb-20 pt-10 sm:px-10 sm:pb-28 sm:pt-12 lg:px-14">
      <SectionHeading
        index="04"
        eyebrow="Resume"
      ...
      />
      <Reveal className="mt-14 flex w-full flex-col items-start gap-4 rounded-2xl border border-border bg-surface p-8 sm:flex-row sm:items-center sm:justify-between">
        <div>
